namespace TeamR.Core.Security
{
	...
	{
		public static readonly SystemAction ViewNotifications = new SystemAction(nameof(ViewNotifications), CoreRoles.Member, CoreRoles.Admin);
		...
		public static readonly SystemAction ViewActivities = new SystemAction(nameof(ViewActivities), CoreRoles.Member, CoreRoles.Admin);
		public static readonly SystemAction ViewUserProfile = new SystemAction(nameof(ViewUserProfile), CoreRoles.Member, CoreRoles.Admin);
		public static readonly SystemAction ViewUserPointsByDayReport = new SystemAction(nameof(ViewUserPointsByDayReport), CoreRoles.Member, CoreRoles.Admin);
		...
		public static readonly SystemAction ViewReport = new SystemAction(nameof(ViewReport), CoreRoles.Member, CoreRoles.Admin);  
