...
function SvelteComponent$21(options) {
	...
	if (!document.getElementById("svelte-1bkmmsg-style")) add_css$7();
...
function create_if_block_1$8(component, state) {
	var action = state.action, each_value = state.each_value, action_index = state.action_index;
	var button, raw_value = action.label;
...
function SvelteComponent$20(options) {
	...
	if (!document.getElementById("svelte-69fm7o-style")) add_css$6();
...
function add_css$8() {
	var style = createElement("style");
	style.id = 'svelte-n8x0nx-style';
	style.textContent = ".svelte-n8x0nx.inline-form,.svelte-n8x0nx .inline-form{border-width:1px 1px 1px;border-style:solid;border-color:#ccc;margin:30px 0;border-radius:5px}.svelte-n8x0nx.inline-form .form-header,.svelte-n8x0nx .inline-form .form-header{border-bottom:none;padding-top:0}";
	appendNode(style, document.head);
}
...
function create_main_fragment$22(component, state) {
	...
	return {
		...
		h: function hydrate() {
			div.className = "inline-form svelte-n8x0nx";
		},
...
function SvelteComponent$22(options) {
	...
	if (!document.getElementById("svelte-n8x0nx-style")) add_css$8();
...
function SvelteComponent$24(options) {
	...
	if (!document.getElementById("svelte-1255lu1-style")) add_css$9();
...
function SvelteComponent$26(options) {
	...
	if (!document.getElementById("svelte-wlqxjg-style")) add_css$10();
...
function SvelteComponent$30(options) {
	...
	if (!document.getElementById("svelte-482oal-style")) add_css$11();
...
function add_css$12() {
	var style = createElement("style");
	style.id = 'svelte-14w0u2n-style';
	style.textContent = ".svelte-14w0u2n.success,.svelte-14w0u2n .success{color:#4CAF50\r\n\t}.svelte-14w0u2n.failed,.svelte-14w0u2n .failed{color:#F44336}.svelte-14w0u2n.icon,.svelte-14w0u2n .icon{font-size:19px;margin-bottom:8px}.svelte-14w0u2n.text,.svelte-14w0u2n .text{font-size:0.9rem}";
	appendNode(style, document.head);
}
...
function create_if_block_1$12(component, state) {
	...
	return {
		c: function create() {
			span = createElement("span");
			span.innerHTML = "<i class=\"fa fa-check-circle icon success\"></i>";
			text = createText("\r\n\t");
...
function create_if_block_2$7(component, state) {
	...
	return {
		c: function create() {
			span = createElement("span");
			span.innerHTML = "<i class=\"fa fa-times-circle icon failed\"></i>";
			text = createText("\r\n\t");
			span_1 = createElement("span");
...
function create_each_block$10(component, state) {
	...
	var if_block = (input.value != null) && create_if_block_4$1(component, state);
...
function create_if_block$18(component, state) {
	...
	var if_block_1 = (state.field.data.values != null) && create_if_block_3$1(component, state);
...
function SvelteComponent$31(options) {
	...
	if (!document.getElementById("svelte-14w0u2n-style")) add_css$12();
...
function SvelteComponent$32(options) {
	...
	if (!document.getElementById("svelte-10hl0oc-style")) add_css$13();
...
function create_if_block_1$13(component, state) {
	...
	function select_block_type(state) {
		if (state.menu.items.length > 1) return create_if_block_2$8;
	...
	var if_block_1 = (state.menu.items.length > 1) && create_if_block_4$2(component, state);
		...
		p: function update(changed, state) {
			...
			if (state.menu.items.length > 1) {
				if (if_block_1) {
					...
					if_block_1 = create_if_block_4$2(component, state);
					if_block_1.c();
					if_block_1.m(if_block_1_anchor.parentNode, if_block_1_anchor);
				}
			} else if (if_block_1) {
