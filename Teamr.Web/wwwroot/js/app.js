...
function create_main_fragment$2(component, state) {
	...
	return {
		...
		h: function hydrate() {
			addListener$1(input, "input", input_input_handler);
			setAttribute(input, "type", "datetime");
			input.id = state.id;
			input.required = input_required_value = state.field.metadata.required;
			input.tabIndex = state.tabindex;
			input.className = "form-control";
...
// (1:4) {{#if !alwaysHideLabel && field.metadata.label !== "" }}
function create_if_block$3(component, state) {
	var div, label, text_value = state.field.metadata.label, text, text_1, div_1, div_1_class_value, div_hidden_value;
	...
	return {
		...
		h: function hydrate() {
			...
			div.hidden = div_hidden_value = !state.visibility;
			div.className = "form-group row svelte-1enahe1";
		},
		...
		p: function update(changed, state) {
			...
			if ((changed.visibility) && div_hidden_value !== (div_hidden_value = !state.visibility)) {
...
function create_if_block_1$2(component, state) {
	var div, div_1, div_1_class_value, div_hidden_value;
...
function SvelteComponent$10(options) {
	...
	this._recompute({ visible: 1 }, this._state);

	if (!document.getElementById("svelte-1enahe1-style")) add_css$2();

	var self = this;
	var _oncreate = function() {
		var changed = { visible: 1, alwaysHideLabel: 1, field: 1, visibility: 1, id: 1, class: 1 };
...
SvelteComponent$10.prototype._recompute = function _recompute(changed, state) {
	if (changed.visible) {
		if (this._differs(state.visibility, (state.visibility = visibility(state.visible)))) changed.visibility = true;
	}
};
...
function SvelteComponent$15(options) {
	...
	if (!document.getElementById("svelte-1enahe1-style")) add_css$4();
...
function add_css$3() {
	var style = createElement("style");
	style.id = 'svelte-16gde6d-style';
	style.textContent = ".svelte-16gde6d.alert-nodata,.svelte-16gde6d .alert-nodata{padding:5px 15px;font-style:italic}.svelte-16gde6d.table>tbody>tr>td .actionlist,.svelte-16gde6d .table>tbody>tr>td .actionlist{background:none;border:none;margin:0;padding:0;text-align:left}.svelte-16gde6d.table,.svelte-16gde6d .table{border:1px solid #e5eff8}.svelte-16gde6d.table thead th,.svelte-16gde6d .table thead th{border-bottom:1px solid #e5eff8;border-left:1px solid #e5eff8;font-weight:normal;background:#f4f9fe;color:#3f6e94}.svelte-16gde6d.table tbody td,.svelte-16gde6d .table tbody td{border-top:1px solid #e9ecef;color:#678197;border-bottom:1px solid #e5eff8;border-left:1px solid #e5eff8}.svelte-16gde6d.table tbody tr:nth-child(even) td,.svelte-16gde6d .table tbody tr:nth-child(even) td{background:#f4f9fe\r\n\t}.svelte-16gde6d.table tbody tr:nth-child(odd) td,.svelte-16gde6d .table tbody tr:nth-child(odd) td{background:#FFF\r\n\t}";
	appendNode(style, document.head);
}
...
function create_if_block$6(component, state) {
	...
	return {
		...
		h: function hydrate() {
			table.className = "table svelte-16gde6d";
		},
...
function create_if_block_2(component, state) {
	...
	return {
		...
		h: function hydrate() {
			div.className = "alert-nodata svelte-16gde6d";
		},
...
function SvelteComponent$14(options) {
	...
	if (!document.getElementById("svelte-16gde6d-style")) add_css$3();
...
function add_css$5() {
	var style = createElement("style");
	style.id = 'svelte-6l04en-style';
	style.textContent = ".svelte-6l04en.tabstrip,.svelte-6l04en .tabstrip{margin:10px 0}.svelte-6l04en.tabstrip>div,.svelte-6l04en .tabstrip>div{display:inline-block}.svelte-6l04en.tabstrip>div>a,.svelte-6l04en .tabstrip>div>a{background:#eef3f7;border-width:1px 1px 1px 1px;border-style:solid;border-color:rgb(187, 210, 214);padding:10px 15px;margin:0 5px 0 0;display:inline-block;text-decoration:none;color:#838c98;font-weight:bold;border-radius:5px}.svelte-6l04en.tabstrip>div>a:hover,.svelte-6l04en .tabstrip>div>a:hover{color:#f3818c}.svelte-6l04en.tabstrip>div>a.active,.svelte-6l04en .tabstrip>div>a.active{margin-bottom:-1px;padding-bottom:11px;background:#fff;border-bottom:none;color:#3287c0;border-bottom-right-radius:3px;border-bottom-left-radius:3px}";
	appendNode(style, document.head);
}
...
function create_main_fragment$17(component, state) {
	...
	return {
		...
		h: function hydrate() {
			div.className = "tabstrip svelte-6l04en";
		},
...
function SvelteComponent$17(options) {
	...
	if (!document.getElementById("svelte-6l04en-style")) add_css$5();
...
function SvelteComponent$19(options) {
	...
	if (!document.getElementById("svelte-16gde6d-style")) add_css$7();
...
function SvelteComponent$18(options) {
	...
	if (!document.getElementById("svelte-18k5o71-style")) add_css$6();
...
function add_css$9() {
	var style = createElement("style");
	style.id = 'svelte-1bkmmsg-style';
	style.textContent = ".svelte-1bkmmsg.response,.svelte-1bkmmsg .response{margin-top:15px;padding-left:10px;padding-right:10px}.svelte-1bkmmsg.inline-form .response,.svelte-1bkmmsg .inline-form .response{margin-top:0;padding:10px 15px}.svelte-1bkmmsg.inline-form h2,.svelte-1bkmmsg .inline-form h2{margin:0;background:#eee;padding:10px 15px 15px;font-size:15px}";
	appendNode(style, document.head);
}
...
function create_if_block_1$9(component, state) {
	var div, h2, text_value = state.responseMetadata.title || state.metadata.label, text;
...
// (12:2) {{#each visibleInputFields as inputField}}
...
// (9:1) {{#if initialized && visibleInputFields.length > 0}}
function create_if_block_2$5(component, state) {
	var div, form, text, button, text_1;

	var each_value = state.visibleInputFields;
...
// (23:2) {{#each outputFieldValues as outputField }}
function create_each_block_1$2(component, state) {
	var outputField = state.outputField, each_value_1 = state.each_value_1, outputField_index = state.outputField_index;
	var if_block_anchor;

	var if_block = (outputField.metadata.hidden == false && !(outputField.metadata.getCustomProperty("hideIfNull") === true && outputField.data === null)) && create_if_block_4(component, state);
...
// (24:2) {{#if outputField.metadata.hidden == false && !(outputField.metadata.getCustomProperty("hideIfNull") === true && outputField.data === null)}}
...
// (21:1) {{#if outputFieldValues != null}}
function create_if_block_3(component, state) {
	var div;

	var each_value_1 = state.outputFieldValues;
...
function create_if_block$12(component, state) {
	...
	var if_block_1 = (state.initialized && state.visibleInputFields.length > 0) && create_if_block_2$5(component, state);

	var if_block_2 = (state.outputFieldValues != null) && create_if_block_3(component, state);
	...
	return {
		...
		h: function hydrate() {
			div.className = div_class_value = "" + state.cssClass + " svelte-1bkmmsg";
		},
		...
		p: function update(changed, state) {
			...
			if (state.initialized && state.visibleInputFields.length > 0) {
				if (if_block_1) {
					...
					if_block_1 = create_if_block_2$5(component, state);
					if_block_1.c();
			...
			if ((changed.cssClass) && div_class_value !== (div_class_value = "" + state.cssClass + " svelte-1bkmmsg")) {
				div.className = div_class_value;
			}
		},
...
function SvelteComponent$21(options) {
	...
	if (!document.getElementById("svelte-1bkmmsg-style")) add_css$9();
...
function add_css$8() {
	var style = createElement("style");
	style.id = 'svelte-69fm7o-style';
	style.textContent = ".svelte-69fm7o.modal .card,.svelte-69fm7o .modal .card{max-width:85%;padding:10px 15px}.svelte-69fm7o.hidden,.svelte-69fm7o .hidden{width:0;height:0;position:absolute;left:-1000px}.svelte-69fm7o.actionlist,.svelte-69fm7o .actionlist{margin:0px 0;padding:0 5px;text-align:right;background:#fff;margin-bottom:15px}.svelte-69fm7o.actionlist>li,.svelte-69fm7o .actionlist>li{list-style-type:none;display:inline-block}";
	appendNode(style, document.head);
}
...
function create_if_block_2$4(component, state) {
	var action = state.action, each_value = state.each_value, action_index = state.action_index;
	var a, text_value = action.label, text, a_href_value;
...
function create_if_block$11(component, state) {
	...
	return {
		...
		h: function hydrate() {
			ul.className = "actionlist svelte-69fm7o";
			addListener$1(input, "change", input_change_handler);
			input.id = input_id_value = "modal-" + state.modalId;
			setAttribute(input, "type", "checkbox");
			input.className = "hidden svelte-69fm7o";
			...
			div.className = "modal svelte-69fm7o";
		},
...
function SvelteComponent$20(options) {
	...
	if (!document.getElementById("svelte-69fm7o-style")) add_css$8();
...
function add_css$10() {
	var style = createElement("style");
	style.id = 'svelte-16ctpml-style';
	style.textContent = ".svelte-16ctpml.inline-form,.svelte-16ctpml .inline-form{border-width:1px 1px 1px;border-style:solid;border-color:#ccc;margin:30px 0;padding:1px 1px;border-radius:5px}";
	appendNode(style, document.head);
}
...
function create_main_fragment$22(component, state) {
	...
	return {
		...
		h: function hydrate() {
			div.className = "inline-form svelte-16ctpml";
		},
...
function SvelteComponent$22(options) {
	...
	if (!document.getElementById("svelte-16ctpml-style")) add_css$10();
...
function create_main_fragment$24(component, state) {
	...
	var if_block = ((state.field.data || {}).value != null) && create_if_block$13(component, state);
...
function SvelteComponent$24(options) {
	...
	if (!document.getElementById("svelte-1255lu1-style")) add_css$11();
...
function create_main_fragment$26(component, state) {
	...
	var if_block = (state.field.data != null) && create_if_block$14(component, state);
...
function create_if_block$14(component, state) {
	...
	var if_block_1 = (state.field.data.message != null) && create_if_block_2$6(component, state);
		...
		p: function update(changed, state) {
			...
			if (state.field.data.message != null) {
				if (if_block_1) {
					...
					if_block_1 = create_if_block_2$6(component, state);
					if_block_1.c();
...
function create_main_fragment$30(component, state) {
	...
	var if_block = (state.field.data != null && state.items != null) && create_if_block$17(component, state);
...
function create_each_block_1$3(component, state) {
	...
	var if_block = (itemField.metadata.hidden == false) && create_if_block_1$11(component, state);
...
function SvelteComponent$30(options) {
	...
	if (!document.getElementById("svelte-482oal-style")) add_css$13();
...
function create_main_fragment$31(component, state) {
	...
	var if_block = (state.field.data != null && state.field.data.values != null) && create_if_block$18(component, state);
	...
	return {
		...
		p: function update(changed, state) {
			if (state.field.data != null && state.field.data.values != null) {
				if (if_block) {
					if_block.p(changed, state);
				} else {
...
// (2:0) {{#each field.data.values as input}}
function create_each_block$10(component, state) {
	...
	var div, strong, text_value = input.label, text, text_1, text_2, span, text_3_value = input.value, text_3, text_4;
	...
	return {
		...
		p: function update(changed, state) {
			...
			if ((changed.field) && text_3_value !== (text_3_value = input.value)) {
...
// (1:0) {{#if field.data != null && field.data.values != null}}
...
controlRegister.registerOutputFieldControl("inline-form", SvelteComponent$22, { alwaysHideLabel: true, block: true });
controlRegister.registerOutputFieldControl("text-value", SvelteComponent$23);
controlRegister.registerOutputFieldControl("text-value-multiline", SvelteComponent$24, { block: true });
controlRegister.registerOutputFieldControl("downloadable-file", SvelteComponent$25);
controlRegister.registerOutputFieldControl("alert", SvelteComponent$26, { alwaysHideLabel: true, block: true });
controlRegister.registerOutputFieldControl("file-size", SvelteComponent$27);
controlRegister.registerOutputFieldControl("image", SvelteComponent$28, { block: true });
controlRegister.registerOutputFieldControl("link", SvelteComponent$29);
controlRegister.registerOutputFieldControl("object-list", SvelteComponent$30, { block: true });
controlRegister.registerOutputFieldControl("form-instance", SvelteComponent$31, { alwaysHideLabel: true });
controlRegister.registerOutputFieldControl("pie-graph", SvelteComponent$32, { block: true });
// Form event handlers.
...
function create_main_fragment$34(component, state) {
	...
	function select_block_type_1(state) {
		if (state.menu.url != null) return create_if_block$20;
...
function create_if_block_3$1(component, state) {
	var a, text_value = state.menu.items[0].label, text, a_href_value;
	...
	return {
		...
		p: function update(changed, state) {
			if ((changed.menu) && text_value !== (text_value = state.menu.items[0].label)) {
				text.data = text_value;
			}
...
function create_each_block$12(component, state) {
	...
	var sveltecomponent = new SvelteComponent$34({
		root: component.root,
...
function create_if_block$20(component, state) {
	var a, text_value = state.menu.label, text, a_href_value;
...
function create_if_block_1$12(component, state) {
	...
	function select_block_type(state) {
		if (state.menu.items.length > 1) return create_if_block_2$7;
	...
	var if_block_1 = (state.menu.items.length > 1) && create_if_block_4$1(component, state);
		...
		p: function update(changed, state) {
			...
			if (state.menu.items.length > 1) {
				if (if_block_1) {
					...
					if_block_1 = create_if_block_4$1(component, state);
					if_block_1.c();
...
function create_main_fragment$33(component, state) {
	...
	var if_block = (state.menus != null) && create_if_block$19(component, state);
...
function create_each_block$11(component, state) {
	...
	var menuitem = new SvelteComponent$34({
		root: component.root,
